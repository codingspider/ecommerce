<?php namespace App\Http\Controllers;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Category Id","name"=>"category_id","join"=>"categories,name"];
			$this->col[] = ["label"=>"Manufacture Id","name"=>"manufacture_id","join"=>"manufactures,name"];
			//$this->col[] = ["label"=>"Images","name"=>"images"];
			...
			$this->form[] = ['label'=>'Manufacture Id','name'=>'manufacture_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'manufactures,name'];
			...
			//$this->form[] = ['label'=>'Manufacture Id','name'=>'manufacture_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'manufacture,id'];
			//$this->form[] = ['label'=>'Images','name'=>'images','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Short Description','name'=>'short_description','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Price','name'=>'price','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
